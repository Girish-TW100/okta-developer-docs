...
The [Okta SDK for PHP](https://github.com/okta/okta-sdk-php) has been archived and is no longer actively maintained or supported. This decision was made as part of our efforts to consolidate and improve our SDK offerings.

The [PHP sample apps](https://github.com/okta/samples-php) have also been archived and are no longer actively maintained or supported.
